...
import (
	...
	memberships "github.com/amiulam/music-catalog/internal/models/memberships"
...
func (m *Mockrepository) GetUser(email, username string, id int64) (*memberships.User, error) {
	m.ctrl.T.Helper()
